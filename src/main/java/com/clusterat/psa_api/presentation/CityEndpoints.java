...
public class CityEndpoints {
    ...
    @GetMapping("/{id}")
    public CompletableFuture<ResponseEntity<CityApplicationDTO.Response>> getCityById(@PathVariable("id") int id) {
    ...
    public CompletableFuture<ResponseEntity<CityApplicationDTO.Response>> getCityByIbgeCode(@PathVariable("ibgeCode") String ibgeCode) {
    ...
    @PostMapping
    public CompletableFuture<ResponseEntity<CityApplicationDTO.Response>> createCity(@Valid @RequestBody CityPresentationDTO.CreateRequest request) {
    ...
    @PutMapping("/{id}")
    public CompletableFuture<ResponseEntity<CityApplicationDTO.Response>> updateCity(@PathVariable("id") int id, @Valid @RequestBody CityPresentationDTO.UpdateRequest request) {
    ...
    @DeleteMapping("/{id}")
    public CompletableFuture<ResponseEntity<Void>> deleteCity(@PathVariable("id") int id) {
